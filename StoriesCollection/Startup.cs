...
namespace StoriesCollection
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "StoriesCollection", Version = "v1" });
            });

            services.AddControllers().AddNewtonsoftJson();

            services.AddScoped<StoriesDbContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "StoriesCollection v1"));
            }
